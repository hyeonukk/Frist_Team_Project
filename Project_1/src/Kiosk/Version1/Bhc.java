...
public class Bhc {
    ...
    public Bhc() {
        ...
        // 디자인단
        // 프레임 설정단
        JFrame frame = new JFrame("BHC");
        frame.setBounds(0, 0, 625, 1000); // 전체적인 프레임 설명
 ...
 //       pNorth.setBackground(new Color(255, 255, 215));
        pNorth.setBackground(new Color(200, 170, 100));
        pNorth.setLayout(null);
        pNorth.setSize(0, 500); // 키오스크 메인 화면크기
        pNorth.setFont(font);
 
        // 배열 설정 부분
        String menu[] = { "뿌링클", "후라이드", "양념치킨", "맛초킹", "핫후라이드", "커리퀸", "치바고", "치즈볼" };
        int price[] = { 18000, 17000, 18000, 18000, 18000, 18000, 18000, 5000 };
        ...
        for (int i = 0; i < menu.length; i++) {
            ...
            icon[i] = new ImageIcon(i + "..image/bhc.png");
           // bt[0].setIcon(new ImageIcon("c:\\bhc.png"));
            bt[0].setIcon(new ImageIcon("c:\\뿌링.png"));
        ...
        pSouth.setFont(font);
        pSouth.setBackground(new Color(50, 50, 50));
